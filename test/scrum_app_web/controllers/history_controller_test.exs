defmodule ScrumAppWeb.HistoryControllerTest do
  use ScrumAppWeb.ConnCase

  alias ScrumApp.Scrum
  alias ScrumApp.Scrum.History

  @create_attrs %{description: "some description", estimate: 120.5, title: "some title"}
  ...
  def fixture(:history) do
    {:ok, history} = Scrum.create_history(@create_attrs)
    history
  end
